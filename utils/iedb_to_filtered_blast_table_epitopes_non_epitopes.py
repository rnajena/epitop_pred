...
with open("/home/go96bix/projects/epitop_pred/utils/iedb_linear_epitopes.fasta") as input_file:
	with open("/home/go96bix/projects/epitop_pred/utils/bepipred_samples_epitopes_non_epitopes.tsv",
	          "w") as output_file:
		...
		for line in input_file:
			if line.startswith(">"):
				...
				with open(f"/home/go96bix/projects/raw_data/bepipred_sequences/{qseqid}_{sseqid}.fasta",
				          "w") as out_fasta:
